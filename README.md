...
Be aware that this is based on repo that has unclear licensing [see
here](https://github.com/sqlc-dev/sqlc-gen-typescript/issues/52).

What I was missing was support for
[libsql](https://github.com/tursodatabase/libsql). I didn't create PR out of
this, because it is waaay to rough around the edges for my liking.

Driver name is 'libsql'. See releases for usage (use it only for libsql, i did
not bother to check other drivers).
